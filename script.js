...
document.getElementById('sorteioButton').addEventListener('click', function () {
    ...
    // 'quantidadeSorteio' recebe o valor do input com ID 'quantidadeSorteio' convertido para inteiro.
    let quantidadeSorteio = parseInt(document.getElementById('quantidadeSorteio').value);

    // 'numeroSorteios' recebe o valor do input com ID 'numeroSorteios' convertido para número inteiro.
    ...
    // Verifica se as entradas são números válidos, se 'totalNumeros' e 'quantidadeSorteio' são maiores que 0, se 'quantidadeSorteio' não é maior que 'totalNumeros', e se 'numeroSorteios' é maior que 0.
    if (isNaN(totalNumeros) || totalNumeros <= 0 || isNaN(quantidadeSorteio) || quantidadeSorteio <= 0 || quantidadeSorteio > totalNumeros || isNaN(numeroSorteios) || numeroSorteios <= 0) {
        ...
        // Interrompe a execuçaõ da função.
        return;
    }
    ...
    function gerarSorteio() {
        ...
        // Inicializa um array vazio que aramazenará os números sorteados.
        let numeros = [];
